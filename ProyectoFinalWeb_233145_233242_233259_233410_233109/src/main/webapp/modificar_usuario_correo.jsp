...
<%
    ...
    Usuario usuario2 = cu.getUsuarioCorreo(usuario);
%>
...
<html lang="es" dir="ltr">
    ...
    <body>
        ...
        <form class="formAdmProducto" action="modificarusuarioporcorreo" method="post">
            <label for="nombre">Nombre:</label>
            <input type="text" id="nombre" name="nombre" placeholder="Ingrese su nombre" maxlength="30" required/>

            <label for="usuario">Usuario:</label>
            <input type="text" id="usuario" name="usuario" placeholder="Ingrese su usuario" maxlength="30" required/>

            <input type="text" id="correo" name="correo" style="display:none;" />
            <br>
            <label for="password">Cambiar contraseña:</label>
            <input type="password" id="password" name="password" placeholder="Ingrese su nueva password" maxlength="30" required />
